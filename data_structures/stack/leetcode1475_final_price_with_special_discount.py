...
if __name__ == "__main__":
    ...
    # Item 0: 8 - 4 = 4 (discount from index 1)
    # Item 1: 4 - 2 = 2 (discount from index 3)
    # Item 2: 6 - 2 = 4 (discount from index 3)
    # Item 3: 2 (no discount)
    # Item 4: 3 (no discount)
    print(Solution().finalPrices([8, 4, 6, 2, 3]))  # Expected: [4, 2, 4, 2, 3]

    # Example 2: No discounts (increasing prices)
