...
Example 1:
    ...
    Preorder: visit 1, left(1)=none, right(1)=2 -> visit 2, left(2)=3, visit 3, right(2)=none.
...
class Solution(object):
    def preorderTraversal(self, root):
        """
        Return preorder traversal (root, left, right) of the tree as a list.
...
if __name__ == "__main__":
    ...
    run_test(s.preorderTraversal(root1), [1, 2, 3], "[1,null,2,3]")
    run_test(s.preorderTraversal(None), [], "empty tree")
    root3 = build_tree([1])
    run_test(s.preorderTraversal(root3), [1], "[1]")
